 ...
 * @author Toshiba
 */
public class ModificarVueloPresidenteJPanel extends javax.swing.JPanel {
     ...
     */
    public ModificarVueloPresidenteJPanel(Principal principal) {
    ...
    /*private void llenarCampos(Avion aviones) {
        String matricula = jTextField1IDVuelo.getText();
    ...
    private void agregar() {
        try {
            ...
            if (valor == false) {
                ...
                principal.volverAGestionAeronave(this);
            }
    ...
    private void buscarParaModificar() {
        String idBuscado = jTextField1IDVuelo.getText();
        principal.controladorColaVuelo.darVueloBuscado(idBuscado);
    }
