 ...
 * @author Toshiba
 */
public class GestionClientePresidenteJPanel extends javax.swing.JPanel {
     ...
     */
    public GestionClientePresidenteJPanel(Principal principal) {
    ...
    public void agregar() {
        principal.irAAgregarClientePresidente(this);
    }

    private void buscar() {
        principal.irABuscarClientePresidente(this);
    }

    private void modificar() {
        principal.irAModificarClientePresidente(this);
    }

    private void eliminar() {
        principal.irAEliminarClientePresidente(this);
    }
