...
public class BuscarVueloPresidenteJPanel extends javax.swing.JPanel {

    private Principal principal;

    public BuscarVueloPresidenteJPanel(Principal principal) {
    ...
    private void jButtonBuscarAeronaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarAeronaveActionPerformed
        if (principal.controladorColaVuelo.validarExisteID(IDBuscado.getText())) {
            ...
            JOptionPane.showMessageDialog(this, "El vuelo no existe", "Error al buscar vuelo", JOptionPane.INFORMATION_MESSAGE, imagenError);
        }
